 ...
 * overlay.
 */
public class WeMapMapsPlugin implements Application.ActivityLifecycleCallbacks {
  ...
  public static void registerWith(Registrar registrar) {
    ...
    final WeMapMapsPlugin plugin = new WeMapMapsPlugin(registrar);
    registrar.activity().getApplication().registerActivityLifecycleCallbacks(plugin);
    registrar
      .platformViewRegistry()
      .registerViewFactory(
        "plugins.flutter.io/wemapgl", new WeMapMapFactory(plugin.state, registrar));

    MethodChannel methodChannel =
            new MethodChannel(registrar.messenger(), "plugins.flutter.io/wemapgl");
  ...
  private WeMapMapsPlugin(Registrar registrar) {
